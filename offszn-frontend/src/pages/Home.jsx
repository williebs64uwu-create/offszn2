...
const Home = () => {
  return (
    <div className="w-full">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="relative min-h-[75vh] flex items-center justify-center px-6 py-20 overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(114,9,183,0.15),transparent_60%)]">
        
        {/* Contenido Hero */}
        <div className="relative z-10 max-w-4xl text-center flex flex-col items-center">
          <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary-light text-xs font-bold tracking-widest uppercase">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed">
            El ecosistema definitivo para productores. Marketplace de élite, herramientas de automatización para YouTube y una comunidad que impulsa tu carrera.
          </p>
